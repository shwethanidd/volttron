...
class DataPlayback(Agent):
    def __init__(self, config_path, **kwargs):
        ...
        try:
            ...
            if self._playback_type == 'airside':
		...
		self._points.add(device_config['arguments']['sat_stpt'].lower())
            elif self._playback_type == 'economizer':
                self._points.add(device_config['arguments']['fan_status'].lower())
                self._points.add(device_config['arguments']['oa_temp'].lower())
                self._points.add(device_config['arguments']['ra_temp'].lower())
                self._points.add(device_config['arguments']['ma_temp'].lower())
                self._points.add(device_config['arguments']['damper_signal'].lower())
                self._points.add(device_config['arguments']['cool_call'].lower())
                self._points.add(device_config['arguments']['fan_speedcmd'].lower())
            else:
                _log.error("Invalid config parameter")
