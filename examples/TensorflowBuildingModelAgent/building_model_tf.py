...
# seq2seq
tf.saved_model.save(model, "models/seq2seq_3860/1/")
...
tf.saved_model.save(encoder_model, "models/s2s_encoder_3860/1/")
tf.saved_model.save(decoder_model, "models/s2s_decoder_3860/1/")
...
loaded_encoder = tf.saved_model.load("models/s2s_encoder_3860/1/")
loaded_decoder = tf.saved_model.load("models/s2s_decoder_3860/1/")
